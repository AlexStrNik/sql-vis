...
/*
 * This file is almost entirely ripped off https://github.com/gpotter2/sketchviz :)
...
function main() {
  if (process.argv.length != 4) {
    console.log("Usage: node sketch.js <input.sql> <output.svg>");
    process.exit(1);
  }
